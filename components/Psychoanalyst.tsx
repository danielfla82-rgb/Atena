...
export const Psychoanalyst: React.FC = () => {
  ...
  return (
    <div className="relative h-[calc(100vh-64px)] flex flex-col overflow-hidden bg-slate-50 dark:bg-slate-950">
      ...
      <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-slate-50 dark:bg-slate-950/40 z-10 backdrop-blur-[2px]"></div>
          <img 
            src={bgImage} 
            alt="Atmosphere" 
      ...
      <div className="relative z-20 p-6 flex items-center justify-between bg-gradient-to-b from-slate-950 to-transparent">
         ...
         <button 
            ...
            className="p-3 bg-white dark:bg-slate-900/50 backdrop-blur-md hover:bg-slate-100 dark:bg-slate-800 rounded-full text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:text-white transition-colors border border-slate-300 dark:border-slate-700"
      ...
      <div className="relative z-20 p-6 bg-gradient-to-t from-slate-950 via-slate-950 to-transparent">
          <div className="max-w-4xl mx-auto relative">
              <div className="absolute inset-0 bg-white dark:bg-slate-900/60 backdrop-blur-xl rounded-2xl -z-10 border border-slate-300 dark:border-slate-700/50"></div>
              <div className="flex gap-3 p-2">
                  <input 
                    ...
                    className="w-full bg-transparent border-none px-4 py-3 text-slate-900 dark:text-white placeholder-slate-400 focus:ring-0 outline-none text-lg"
                    disabled={loading}
                    autoFocus
                  />
