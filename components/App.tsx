...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col md:flex-row text-slate-100 font-sans">
      
      {/* Global Study Session Overlay */}
      {activeSession && <StudySession notebook={activeSession} onClose={endSession} />}

      {/* --- Mobile Header --- */}
      <div className="md:hidden bg-white dark:bg-slate-900 p-4 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center sticky top-0 z-40">
        ...
        <button onClick={() => setSidebarOpen(!sidebarOpen)} className="text-slate-600 dark:text-slate-300 hover:text-slate-900 dark:text-white transition-colors">
          {sidebarOpen ? <X /> : <Menu />}
        </button>
      </div>
      ...
      `}>
        ...
        <div className="space-y-1 flex-1">
          ...
          <div>
              <button 
                ...
                className={`w-full flex items-center justify-between px-3 py-2 mt-2 mb-1 rounded-lg transition-colors group hover:bg-slate-100 dark:bg-slate-800 cursor-pointer select-none`}
              >
                  <span className={`text-[10px] uppercase font-bold tracking-wider ${strategyMenuOpen ? 'text-slate-900 dark:text-white' : 'text-slate-500 group-hover:text-slate-600 dark:text-slate-300'}`}>
                      Estratégia
                  </span>
          ...
          <div className="pt-2">
              <button 
                ...
                className={`w-full flex items-center justify-between px-3 py-2 mt-2 mb-1 rounded-lg transition-colors group hover:bg-slate-100 dark:bg-slate-800 cursor-pointer select-none`}
              >
                  <span className={`text-[10px] uppercase font-bold tracking-wider ${intelligenceMenuOpen ? 'text-slate-900 dark:text-white' : 'text-slate-500 group-hover:text-slate-600 dark:text-slate-300'}`}>
                      Inteligência
                  </span>
                  <ChevronDown size={14} className={`text-slate-500 transition-transform duration-300 ${intelligenceMenuOpen ? 'rotate-180 text-slate-900 dark:text-white' : ''}`} />
              </button>
              ...
              <div className={`overflow-hidden transition-all duration-300 ease-in-out space-y-1 ${intelligenceMenuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
                  <button 
                    ...
                    className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ml-1 border-l-2 ${isActive('diagnostics') ? 'bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white border-purple-500' : 'border-transparent text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:bg-slate-800 hover:text-slate-900 dark:text-white font-medium'}`}
                  >
                    <Activity size={18} />
          ...
          <div className="pt-2">
              <button 
                ...
                className={`w-full flex items-center justify-between px-3 py-2 mt-2 mb-1 rounded-lg transition-colors group hover:bg-slate-100 dark:bg-slate-800 cursor-pointer select-none`}
              >
                  <span className={`text-[10px] uppercase font-bold tracking-wider ${mentalMenuOpen ? 'text-slate-900 dark:text-white' : 'text-slate-500 group-hover:text-slate-600 dark:text-slate-300'}`}>
                      Mental & Físico
                  </span>
                  <ChevronDown size={14} className={`text-slate-500 transition-transform duration-300 ${mentalMenuOpen ? 'rotate-180 text-slate-900 dark:text-white' : ''}`} />
              </button>
              ...
              <div className={`overflow-hidden transition-all duration-300 ease-in-out space-y-1 ${mentalMenuOpen ? 'max-h-96 opacity-100' : 'max-h-0 opacity-0'}`}>
                  ...
                  <button 
                      ...
                      className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ml-1 border-l-2 ${isActive('nietzsche') ? 'bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white border-orange-500' : 'border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:text-white hover:bg-slate-100 dark:bg-slate-800/50'}`}
                    >
                  ...
                  <button 
                      ...
                      className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ml-1 border-l-2 ${isActive('psycho') ? 'bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white border-indigo-500' : 'border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:text-white hover:bg-slate-100 dark:bg-slate-800/50'}`}
                    >
                  ...
                  <button 
                      ...
                      className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ml-1 border-l-2 ${isActive('protocol') ? 'bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white border-blue-500' : 'border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:text-white hover:bg-slate-100 dark:bg-slate-800/50'}`}
                    >
                  ...
                  <button 
                      ...
                      className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ml-1 border-l-2 ${isActive('tips') ? 'bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white border-yellow-500' : 'border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:text-white hover:bg-slate-100 dark:bg-slate-800/50'}`}
                    >
          ...
          {/* Seção Sistema (Fixa) */}
          <div className="pt-2 mt-4 border-t border-slate-200 dark:border-slate-800/50">
            <button 
                onClick={() => { setView('docs'); setSidebarOpen(false); }}
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ${isActive('docs') ? 'bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white border border-slate-300 dark:border-slate-700 font-bold' : 'text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:bg-slate-800 hover:text-slate-900 dark:text-white font-medium'}`}
              >
                <Book size={18} />
            ...
            <button 
                ...
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ${isActive('about') ? 'bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white border border-slate-300 dark:border-slate-700 font-bold' : 'text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:bg-slate-800 hover:text-slate-900 dark:text-white font-medium'}`}
              >
                <Shield size={18} />
        ...
        <div className="mt-4 pt-4 border-t border-slate-200 dark:border-slate-800">
          <div className="bg-slate-100 dark:bg-slate-800/50 border border-slate-300 dark:border-slate-700/50 rounded-xl p-3 flex items-center gap-3">
            <div className="w-9 h-9 rounded-lg bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center text-xs font-bold text-slate-900 dark:text-white shadow-inner flex-shrink-0">
