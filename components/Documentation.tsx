    ...
    <div className="p-6 max-w-6xl mx-auto space-y-8 pb-20 animate-in fade-in duration-500">
      ...
      <div className="border-b border-slate-200 dark:border-slate-800 pb-6 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        ...
        <div className="text-right hidden md:block">
            ...
            <p className="text-slate-600 dark:text-slate-300 font-mono">v10.0.0</p>
        </div>
      </div>
        ...
        <div className="lg:col-span-3 space-y-16">
           ...
           <section id="arquitetura" className="space-y-6 scroll-mt-24">
              <div className="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800 pb-2">
                 ...
                 <h2 className="text-2xl font-bold text-slate-900 dark:text-white">2. Stack Tecnológica</h2>
              </div>
              
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                 <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-xl hover:border-blue-500/30 transition-colors">
                 ...
                 <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-xl hover:border-purple-500/30 transition-colors">
                    <h3 className="font-bold text-slate-900 dark:text-white mb-4 flex items-center gap-2">
           ...
           <section id="algoritmo" className="space-y-6 scroll-mt-24">
              <div className="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800 pb-2">
                 ...
                 <h2 className="text-2xl font-bold text-slate-900 dark:text-white">3. O Algoritmo Atena (v2.0)</h2>
              </div>
              
              <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-8 rounded-2xl relative overflow-hidden">
  ...
  Tendência "Alta"       -> x0.9 (Leve aumento de frequência)`}</pre>
           ...
           <section id="dados" className="space-y-6 scroll-mt-24">
              <div className="flex items-center gap-3 border-b border-slate-200 dark:border-slate-800 pb-2">
                 ...
                 <h2 className="text-2xl font-bold text-slate-900 dark:text-white">4. Modelagem de Dados</h2>
              </div>
...
const DataEntity = ({ title, desc, fields }: { title: string, desc: string, fields: {name: string, type: string}[] }) => (
    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 p-6 rounded-xl">
        ...
        <p className="text-slate-500 dark:text-slate-400 text-sm mb-4">{desc}</p>
        <div className="bg-slate-50 dark:bg-slate-950 rounded-lg p-3 border border-slate-200 dark:border-slate-800/50">
