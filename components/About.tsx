...
export const About: React.FC = () => {
  return (
    <div className="p-6 max-w-5xl mx-auto space-y-12 pb-20 animate-in fade-in duration-700">
      ...
      {/* Hero Section */}
      <div className="relative rounded-3xl overflow-hidden bg-slate-900 border border-slate-800 shadow-2xl min-h-[400px] flex items-center">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-1 gap-4">
              <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl hover:border-indigo-500/30 transition-all group">
                  <div className="flex items-start gap-4">
                      <div className="p-3 bg-indigo-900/20 rounded-lg text-indigo-400 group-hover:text-indigo-300"><Sword size={24} /></div>
                      <div>
                          <h3 className="font-bold text-white text-lg">Guerra Justa</h3>
                          <p className="text-sm text-slate-400 mt-1">Diferente de Ares (fúria sanguinária), Atena rege a guerra disciplinada e organizada. O concurso é uma guerra fria e mental.</p>
                      </div>
                  </div>
              </div>
              <div className="bg-slate-900 border border-slate-800 p-6 rounded-xl hover:border-emerald-500/30 transition-all group">
                  <div className="flex items-start gap-4">
                      <div className="p-3 bg-emerald-900/20 rounded-lg text-emerald-400 group-hover:text-emerald-300"><Scroll size={24} /></div>
                      <div>
                          <h3 className="font-bold text-white text-lg">Nascida Pronta</h3>
                          <p className="text-sm text-slate-400 mt-1">Atena nasceu da cabeça de Zeus já vestida com armadura. A plataforma visa preparar você para chegar no dia da prova "vestido para a batalha", sem improvisos.</p>
                      </div>
                  </div>
              </div>
          </div>
      ...
      <div className="border-t border-slate-800 pt-12">
          <h2 className="text-2xl font-bold text-white mb-8 text-center uppercase tracking-widest text-sm text-slate-500">Simbologia Aplicada</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="bg-gradient-to-b from-slate-900 to-slate-950 p-8 rounded-2xl border border-slate-800 text-center hover:-translate-y-2 transition-transform duration-500">
                  <div className="mx-auto w-16 h-16 bg-slate-800 rounded-full flex items-center justify-center mb-6 text-amber-400 shadow-lg shadow-amber-900/10">
                      <Eye size={32} />
                  </div>
                  <h3 className="text-xl font-bold text-white mb-3">A Coruja</h3>
              ...
              <div className="bg-gradient-to-b from-slate-900 to-slate-950 p-8 rounded-2xl border border-slate-800 text-center hover:-translate-y-2 transition-transform duration-500 relative overflow-hidden">
                  <div className="absolute top-0 inset-x-0 h-1 bg-emerald-500"></div>
                  <div className="mx-auto w-16 h-16 bg-slate-800 rounded-full flex items-center justify-center mb-6 text-emerald-400 shadow-lg shadow-emerald-900/10">
                      <Shield size={32} />
                  </div>
                  <h3 className="text-xl font-bold text-white mb-3">A Égide (Escudo)</h3>
                  <p className="text-sm text-slate-400 leading-relaxed">
              ...
              <div className="bg-gradient-to-b from-slate-900 to-slate-950 p-8 rounded-2xl border border-slate-800 text-center hover:-translate-y-2 transition-transform duration-500">
                  <div className="mx-auto w-16 h-16 bg-slate-800 rounded-full flex items-center justify-center mb-6 text-cyan-400 shadow-lg shadow-cyan-900/10">
                      <Feather size={32} />
                  </div>
                  <h3 className="text-xl font-bold text-white mb-3">A Lança (Foco)</h3>
                  <p className="text-sm text-slate-400 leading-relaxed">
      ...
      {/* Quote */}
      <div className="text-center py-12 px-6 bg-slate-900/50 rounded-3xl border border-slate-800/50">
          <p className="text-xl md:text-2xl font-serif italic text-slate-300 mb-4">
