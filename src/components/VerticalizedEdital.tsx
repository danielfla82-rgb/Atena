...
export const VerticalizedEdital: React.FC<Props> = ({ onNavigate }) => {
  ...
  const handleTopicClick = (e: React.MouseEvent, topicName: string, disciplineName: string, existingId?: string) => {
      e.stopPropagation();
      e.preventDefault();
                                              ...
                                              return (
                                                  <tr key={idx} className="hover:bg-slate-800/20 transition-colors group">
                                                      ...
                                                      <td 
                                                        ...
                                                        onClick={(e) => handleTopicClick(e, topic.name, discipline.name, stats.matchedId)}
                                                      >
                                                          {topic.name}
                                                      </td>
                                                      <td className="p-4 text-center">
