...
export const Library: React.FC = () => {
  ...
  useEffect(() => {
      ...
      if (!loading && focusedNotebookId) {
          ...
          // REMOVED: The aggressive "else" block that cleared the ID if not found immediately.
          // This fixes the race condition where the notebook wasn't found in the first render cycle.
      }
