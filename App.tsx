    ...
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col md:flex-row text-slate-900 dark:text-slate-100 font-sans transition-colors duration-300">
      ...
      `}>
        ...
        <div className="mb-10 mt-2 hidden md:flex flex-col items-center text-center cursor-pointer group" onClick={() => setView('selection')}>
            ...
            <h1 className="text-2xl font-black tracking-[0.2em] text-slate-900 dark:text-white leading-none group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                ATENA
            </h1>
            <p className="text-[10px] text-emerald-600 dark:text-emerald-500 font-bold uppercase tracking-[0.2em] mt-2 opacity-80 group-hover:opacity-100 group-hover:tracking-[0.3em] transition-all whitespace-nowrap">
          ...
          <div className="pt-4 mt-2">
              ...
              <div className="mt-2 space-y-1">
                  <button 
                    ...
                    >
                      <Pyramid size={18} className={isActive('framework') ? 'text-emerald-500 dark:text-emerald-400' : ''}/>
      ...
      <main className="flex-1 overflow-y-auto h-screen relative bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
         {/* Background Glow */}
         <div className="fixed top-0 left-0 w-full h-full bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-emerald-100 dark:from-emerald-900/10 via-slate-50 dark:via-slate-950 to-slate-50 dark:to-slate-950 pointer-events-none -z-10 transition-colors duration-300"></div>
