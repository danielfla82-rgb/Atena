...
import { AdminEditais } from "./components/AdminEditais";
import { AdminPlanejamentos } from "./components/AdminPlanejamentos";
import { AdminTeorias } from "./components/AdminTeorias";
...
import { Teorias } from "./components/Teorias";
...
const AppContent: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col md:flex-row text-slate-900 dark:text-slate-100 font-sans transition-colors duration-300">
      ...
      {activeSession && (
        <StudySession notebook={activeSession} onClose={endSession} />
      )}
      ...
      >
        ...
        <div
          className="mb-10 mt-2 hidden md:flex flex-col items-center text-center cursor-pointer group"
        ...
        <div className="space-y-1 flex-1">
          ...
          <div>
            ...
            >
              <span
                className={`text-[10px] uppercase font-bold tracking-wider ${strategyMenuOpen ? "text-slate-900 dark:text-white" : "text-slate-500 group-hover:text-slate-700 dark:group-hover:text-slate-600 dark:text-slate-300"}`}
              >
                Planejamento
              </span>
              <ChevronDown
                size={14}
                className={`text-slate-500 transition-transform duration-300 ${strategyMenuOpen ? "rotate-180 text-slate-900 dark:text-white" : ""}`}
              />
            </button>

            <div
              className={`overflow-hidden transition-all duration-300 ease-in-out space-y-1 ${strategyMenuOpen ? "max-h-[500px] opacity-100" : "max-h-0 opacity-0"}`}
            >
              <button
                onClick={() => {
                  setView("dashboard");
              ...
              >
                <LibraryIcon size={18} />
                <span className="text-sm">Banco de Assuntos</span>
              </button>
              ...
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ml-1 border-l-2 ${isActive("teorias") ? "bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white border-green-500" : "border-transparent text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white font-medium"}`}
              >
                <Book size={18} />
                <span className="text-sm">Biblioteca Atena</span>
              </button>
          ...
          <div className="pt-4 mt-2">
            ...
            <div className="mt-2 space-y-1">
              <button
                ...
                className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ml-1 border-l-2 ${isActive("framework") ? "bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white border-green-500 font-bold" : "border-transparent text-slate-500 dark:text-slate-400 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800/50 font-medium"}`}
              >
                <Pyramid
                  size={18}
                  className={
              ...
              >
                ...
                <span className="text-[13px] tracking-wide">Cronômetro</span>
              </button>

              {isAdmin && (
                <div className="pt-2 border-t border-slate-200 dark:border-slate-800">
                  <div className="px-5 mb-2 mt-2">
                    <span className="text-[10px] font-black uppercase tracking-widest text-slate-400 dark:text-slate-500 bg-slate-100 dark:bg-slate-800/50 px-2 py-1 rounded inline-block">
                      Apenas Admins
                    </span>
                  </div>
                  <button
                    onClick={() => {
                      setView("banco-assuntos");
                      setSidebarOpen(false);
                    }}
                    className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ml-1 border-l-2 ${isActive("banco-assuntos") ? "bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white border-green-500 font-bold" : "border-transparent text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white font-medium"}`}
                  >
                  ...
                  <button
                    onClick={() => {
                      setView("admin-editais");
                      setSidebarOpen(false);
                    }}
                    className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ml-1 border-l-2 ${isActive("admin-editais") ? "bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white border-green-500 font-bold" : "border-transparent text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white font-medium"}`}
                  >
                  ...
                  <button
                    onClick={() => {
                      setView("admin-planejamentos");
                      setSidebarOpen(false);
                    }}
                    className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ml-1 border-l-2 ${isActive("admin-planejamentos") ? "bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white border-green-500 font-bold" : "border-transparent text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white font-medium"}`}
                  >
                  ...
                  <button
                    onClick={() => {
                      setView("admin-teorias");
                      setSidebarOpen(false);
                    }}
                    className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ml-1 border-l-2 ${isActive("admin-teorias") ? "bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white border-green-500 font-bold" : "border-transparent text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white font-medium"}`}
                  >
                    <Book className="w-5 h-5 opacity-70" />
                    <span className="text-[13px] tracking-wide">
                      Módulos Teóricos
                  ...
                  <button
                    onClick={() => {
                      setView("gerenciar-questoes");
                      setSidebarOpen(false);
                    }}
                    className={`w-full flex items-center gap-3 px-4 py-2.5 rounded-xl transition-all ml-1 border-l-2 ${isActive("gerenciar-questoes") ? "bg-slate-100 dark:bg-slate-800 text-slate-900 dark:text-white border-green-500 font-bold" : "border-transparent text-slate-500 dark:text-slate-400 hover:bg-slate-100 dark:hover:bg-slate-800 hover:text-slate-900 dark:hover:text-white font-medium"}`}
                  >
                    <Book className="w-5 h-5 opacity-70" />
                    <span className="text-[13px] tracking-wide">
                      Banco de Questões
          ...
          <div className="bg-slate-100 dark:bg-slate-800/50 border border-slate-200 dark:border-slate-700/50 rounded-xl p-3 flex items-center gap-3">
            ...
            <div className="flex-1 min-w-0 overflow-hidden">
              <p
                ...
                title={user?.email || "Visitante"}
              >
                {user?.email || "Visitante"}
              </p>
              <p className="text-[10px] text-green-600 dark:text-green-400 font-mono mt-0.5">
                Online
              </p>
            </div>
            <ThemeToggle />
            <button
              ...
              className="text-slate-500 hover:text-red-500 dark:hover:text-red-400 transition-colors p-1"
              title="Sair"
            >
              <LogOut size={16} />
            </button>
      ...
      <main className="flex-1 overflow-y-auto h-screen relative bg-slate-50 dark:bg-slate-950 transition-colors duration-300">
        ...
        {/* Roteamento de Views */}
        {view === "dashboard" ? (
          <Dashboard onNavigate={(v) => setView(v as any)} />
        ) : view === "setup" ? (
          <Setup onNavigate={(v) => setView(v as any)} />
        ) : view === "verticalized" ? (
          <VerticalizedEdital onNavigate={(v) => setView(v as any)} />
        ) : view === "review-list" ? (
          <ReviewList onNavigate={(v) => setView(v as any)} />
        ) : view === "library" ? (
          <Library key="library" />
        ) : view === "teorias" ? (
          <Teorias />
        ) : // import { QuestionManager } from './components/Questions/QuestionManager'; // Note: Not doing this line as targeted
        view === "banco-assuntos" ? (
          <Library key="banco-assuntos" isBankMode={true} />
        ) : view === "admin-editais" ? (
          <AdminEditais />
        ) : view === "admin-planejamentos" ? (
          <AdminPlanejamentos />
        ) : view === "admin-teorias" ? (
          <AdminTeorias />
        ) : view === "disciplines" ? (
          <DisciplineManager onNavigate={(v) => setView(v as any)} />
        ) : view === "simulados" ? (
          <Simulados />
        ) : view === "questoes" ? (
          <div className="h-full flex flex-col">
            <div className="p-4 bg-white/50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center">
              <h1 className="font-bold flex items-center gap-2">
                <Target className="text-blue-500" /> Bateria de Questões
              </h1>
              <button
          ...
          <div className="h-full flex flex-col">
            <div className="p-4 bg-white/50 dark:bg-slate-900/50 border-b border-slate-200 dark:border-slate-800 flex justify-between items-center">
              <h1 className="font-bold flex items-center gap-2">
                <Layers className="text-blue-500" /> Gerenciar Cadernos
              </h1>
              <button
